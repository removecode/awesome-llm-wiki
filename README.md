...
- [OpenKB](https://github.com/VectifyAI/OpenKB) - An open-source Python CLI knowledge base framework that compiles multi-format documents into interlinked markdown vaults using a specialized tree-based index for vectorless long-document retrieval.
